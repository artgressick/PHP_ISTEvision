<?php
	function emailer($to,$subject,$message,$from='programmers@techitsolutions.com',$cc='',$bcc='',$mb_language='en',$mb_convert_encoding='UTF-8',$attachments=array()) {
		if($from == '') { $from = 'programmers@techitsolutions.com'; }
...
$email = "programmers@techitsolutions.com"; //senders e-mail adress
$recipient = $to; //recipient
$mail_body = decode($message); //mail body
$subject = decode($subject); //subject
$header = "From: ". $Name . " <" . $email . ">\r\n"; //optional headerfields

if(mail($recipient, $subject, $mail_body, $header)) { return true; } else { return false; }
*/
