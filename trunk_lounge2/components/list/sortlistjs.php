...
?>					<td><? if($row['checked_datetime'] != "") { ?><input type='button' onclick="javascript:document.getElementById('idReset').value='<?=$row['id']?>';document.getElementById('idForm').submit();" value='Reset' /><? } else { ?>&nbsp;<? } ?></td>
<?
