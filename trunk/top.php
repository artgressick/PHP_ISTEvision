				...
				<tr>
					<td>
						<div class="slider-header">
								Top <?= $channels['name'] ?> <a href="channel.php?c=<?= $channels['cid'] ?>&v=4"><img src="images/goto-channel.png" alt="Go to channel" width="97" height="18" class="goto-channel" border="0" /></a>
						</div>
