...
?>
	...
	<script type='text/javascript'>
		...
		function error_check() {
			...
			else if(errEmpty('org_file', "Invalid File Extension, Only AVI, WMV, MOV, MP4 or M4V files are allowed.","extension")) { totalErrors++; }
	...
	<tr>
		<td class="contents">
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr>
<!-- contents -->
					<form action="uploadfile.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return error_check()">
					<div id='errors'></div>
...
?>
							...
							<tr>
								<td style="padding-right: 20px; padding-top: 15px;" valign="top">
									<div style="padding: 5px; margin-bottom: 15px; width: 70%; background: red; color: white; font-weight: bold;">
										Please limit the video to about 10 minutes or less in length.
									</div>
									
									<div class="form_div">
										<span class="form_required">Your Video File</span>: 
										<input type="hidden" name="MAX_FILE_SIZE" value="179200000">
										<input name="org_file" type="file" id="org_file" size="25"Ê/><br />
										<span style=" font-size:10px; color:#F00; font-style:italic;">NOTE: Files may be AVI, WMV, MOV, M4V, MP4 and a Maximum of 175 MB. </span> <a href="help.php"><big style="color: rgb(255, 0, 0);"><span style="font-weight: bold;">Need some help?</span></big></a>
									</div>
