...
?>
	<table cellpadding="0" cellspacing="0" style="width:100%;">
		<tr>
			<td style='vertical-align:top; text-align:center; padding-top:400px; padding-bottom:100px;'>
				<div style="font-weight:bold; font-size:28px;">Looks like there is already an account with that email address.
							<br /><br /><input type=button value="Back" onClick="history.go(-1)" style="font-size:28px;" /></div>
			</td>
		</tr>
	</table>
