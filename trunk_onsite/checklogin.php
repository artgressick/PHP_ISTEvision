	...
	if (isset($_POST['login'])) {
		...
		if ($result) {
			...
			if ($account_verification['customer_status_id'] == 1) {
				...
				if($_POST['key'] == '380891959a0754c24a7ad3525c2d1e77' && $account_verification['id'] != 304) {
					header ("Location: index.php");
					exit();
				} else if($_POST['key'] == '10b5aea7f9cf8449af6c5218d023790f' && $account_verification['id'] != 0) {
					header ("Location: index.php");
					exit();
				} else if($_POST['key'] == 'de2f15d014d40b93578d255e6221fd60' && $account_verification['id'] != 0) {
					header ("Location: index.php");
					exit();
				} else if($_POST['key'] == '45tyhnjm87ik234rwefujisekj409jkf' && $account_verification['id'] != 303) {
					header ("Location: index.php");
					exit();
				}
