...
<?	
	switch ($_SESSION['user']) {
	    case "380891959a0754c24a7ad3525c2d1e77": //Gerald
	        $link = "addvideo-gerald.php";
	        break;
	    case "10b5aea7f9cf8449af6c5218d023790f": //eschool
	        $link = "addvideo-eschool.php";
	        break;
	    case "de2f15d014d40b93578d255e6221fd60": //Mario
	        $link = "addvideo-mario.php";
	        break;
	}
?>
							<a href="<?=$link?>">Post a Story</a>
						</div>
					</td>
				</tr>
			</table>
...
?>
						<a href="editvideo2.php?vid=<?= $videos['vid']?>">Edit</a>
<?
		$divider = 1;
	}
...
?>
				<tr align="center">
					<td height="20" colspan="5" style="background-color:white;"><font size="1" face="Arial, Helvetica, sans-serif">You haven't added any stories yet. <a href="<?=$link?>">Add a story today</a></font></td>
				</tr>
<?
	}
?>
